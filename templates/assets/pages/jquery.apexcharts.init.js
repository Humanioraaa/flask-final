...
$(document).ready(function () {
    ...
    var chart = new ApexCharts(document.querySelector("#apex_area2"), options);
...
var chart = new ApexCharts(document.querySelector("#apex_column1"), options);
...
var chart = new ApexCharts(document.querySelector("#apex_column2"), options);
...
var chart = new ApexCharts(document.querySelector("#apex_mixed"), options);
...
var chart = new ApexCharts(document.querySelector("#apex_bubble"), options2);
...
var chart = new ApexCharts(document.querySelector("#apex_pie1"), options);
...
var chart = new ApexCharts(document.querySelector("#apex_pie3"), options);
...
var chart = new ApexCharts(document.querySelector("#apex_radialbar1"), options);
...
var chart = new ApexCharts(document.querySelector("#apex_radialbar2"), options);
...
var chart = new ApexCharts(document.querySelector("#apex_radialbar3"), options);
